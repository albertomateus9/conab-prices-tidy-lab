...
PROJECT = {
  ...
  "kind": "tidy_prices",
  "dataset": "CONAB-style food price sample",
  "source": "https://www.conab.gov.br/",
  "description": "Tidy data lab for transforming wide price tables into long format and calculating variation.",
  "concepts": [
    "melt",
    "groupby",
    "pct_change",

...
PROJECT = {
  "code": "P04",
  "slug": "conab-prices-tidy-lab",
  "title": "Laboratorio CONAB De Precos E Tidy Data",
  "discipline": "Armazenamento, Manipulacao E Transformacao De Dados I",
  "disciplinePt": "Armazenamento, Manipulacao E Transformacao De Dados I",
  "kind": "tidy_prices",
  "dataset": "Amostra segura local",
  "source": "Amostra sintetica local",
  "description": "Transformacao de tabelas wide para long e calculo de variacao percentual em precos sinteticos.",
  "topics": [
    "data-science",
    "python",
    "jupyter-notebook",
